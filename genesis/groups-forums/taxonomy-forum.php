...
add_action( 'genesis_before_content', 'gf_genesis_before_content' );

function gf_genesis_before_content() {
...
add_action( 'genesis_after_loop', 'gf_genesis_after_loop' );

function gf_genesis_after_loop() {
	// pagination
	global $wp_query;
